  ...
  return (
    <>
      ...
      <nav className="w-full px-5 gap-3 h-20 shadow relative z-[30] flex items-center justify-between bg-[#073B52]   md:flex md:justify-between md:items-center">
        ...
        <ul
          className={`md:flex md:items-center -z-50  md:z-auto md:static absolute bg-[#073B52] w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:opacity-100  mt-0 transition-all ease-in duration-500 ${
